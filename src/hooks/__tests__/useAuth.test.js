/**
 * Unit tests for the useAuth demo hook.
 * Covers the full login/logout cycle, including both the success
 * and failure paths of the (simulated, client-side-only) credential
 * check.
 */
